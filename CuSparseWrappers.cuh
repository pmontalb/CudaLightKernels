...
EXTERN_C
{
	...
	*/
	...
	inline EXPORT int _SparseSubtractRaw(const ptr_t z, const ptr_t x, const ptr_t y, const unsigned nNonZeros, const ptr_t nonZeroIndices, const MemorySpace memorySpace, const MathDomain mathDomain, const unsigned size) { return _SparseAddRaw(z, x, y, nNonZeros, nonZeroIndices, memorySpace, mathDomain, -1.0); }
